...
namespace IceBot.Classes
{
    ...
    public class SQLiteDatabase
	{
		...
		public void MassInsert(String tableName, Dictionary<int, Dictionary<string, string>> data)
		{
			...
			{
				Console.WriteLine("ERROR: {0} : {1} : {2}", exc.Message, exc.TargetSite, exc.StackTrace);

				//logFuncs.AddToLogs(string.Format("ERROR: {0} : {1} : {2}", exc.Message, exc.TargetSite, exc.InnerException), "ERROR");
			}
	...
	public class SQLite
	{
		private static SQLiteDatabase sqlDB = new SQLiteDatabase();
		...
		public void Insert(string table, Dictionary<string, string> data)
		{
			...
			catch (Exception crap)
			{
				...
				Console.WriteLine("ERROR ADDING LINK: {0}", crap.Message);
			}
